...
export CARDANO_NODE_SOCKET_PATH=/home/mike/dev/mlabs/net-setups/testnet-bpi-setup/socket/node.socket
export PATH="/home/mike/dev/mlabs/net-setups/testnet-bpi-setup/binaries:$PATH"
